...
def read_json_file(bucket, key):
    ...
    s3_client = boto3.client('s3', 
        ...
        aws_access_key_id='AKIA3D7SCDGMPJNDQCWN',
        aws_secret_access_key='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')
...
def read_df_from_s3(bucket, key):
    ...
    return pd.read_csv(
        f's3://{bucket}/{key}',
        storage_options={
            "key":'AKIA3D7SCDGMPJNDQCWN',
            "secret":'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'
        }
    )

def get_latest_listings_dt(prefix='api/rapid_api/zillow/property_listings'):

    s3 = boto3.resource('s3', aws_access_key_id='AKIA3D7SCDGMPJNDQCWN', 
                        aws_secret_access_key='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')
